...
from .forms import LoginForm, RegistrationForm, EditForm, PasswordResetForm, ContactForm
from .tasks import reset_password, contact_created
...
def contact_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            # Здесь можно реализовать отправку письма или сохранение
            messages.success(request, "Сообщение успешно отправлено.")
            contact_created.delay(form.cleaned_data)
            return redirect('/')
